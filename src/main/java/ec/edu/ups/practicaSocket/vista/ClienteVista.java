...
import ec.edu.ups.pracicaSocket.controlador.Cliente;
import ec.edu.ups.pracicaSocket.controlador.Servidor;
...
public class ClienteVista extends javax.swing.JFrame {
     ...
     */
    public ClienteVista(String host, int port) throws IOException {
        initComponents();
        socket = new Socket(host, port);
        cli = new Cliente(socket);
    }
